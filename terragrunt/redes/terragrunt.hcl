...
terraform {
  source = "../../modules/project-scenario//"
}
...
# These are automatically merged into the child `terragrunt.hcl` config via
# the include block.
# ------------------------------------------------------------------------------

# Configure root level variables that all resources can inherit.
# This is especially helpful with multi-account configs where
